...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:ObjectDataSource ID="SupplierSummaryDataSource" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="ListSupplierSummary" TypeName="WestWindSystem.BLL.SupplierController"></asp:ObjectDataSource>
</asp:Content>